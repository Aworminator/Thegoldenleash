...
const sections = [boarding, daycare, walks, grooming];
...
house.addEventListener("click", () => showSection(boarding));
// Add other icon listeners here:
walkIcon.addEventListener("click", () => showSection(walks));
daycareIcon.addEventListener("click", () => showSection(daycare));
groomingIcon.addEventListener("click", () => showSection(grooming));
